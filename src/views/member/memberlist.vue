...
<!--       <el-button :loading="downloadLoading" class="filter-item" type="primary" icon="el-icon-download" @click="handleDownload">导出</el-button> -->
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" label="管理员角色" prop="branch">
        <template slot-scope="scope">
          <el-tag type="primary" style="margin-right: 20px;"> {{ formatRole(scope.row.branch) }} </el-tag>
        </template>
      </el-table-column>
...
<!--         <el-form-item label="管理员头像" prop="avatar">
        ...
        <el-form-item label="管理员角色" prop="roleIds">
          <el-select v-model="dataForm.branch" multiple placeholder="请选择">
            <el-option
